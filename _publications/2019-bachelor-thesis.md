---
title: "Numerical Models and Cardiac Electrophysiology Simulations for Long QT Syndrome"
collection: publications
category: theses
thesis_type: "Bachelor Thesis"
supervisor: "Luca Franco Pavarino"
permalink: /publication/2019-bachelor-thesis
...
A particularly significant contribution of mathematical modeling lies in the study of the cardiovascular system, encompassing cardiac mechanics, electrophysiology, fluid dynamics, and their intricate interactions. Over the past two decades, numerous models have been developed to represent and simulate the various functions of the heart. Notably, these include models describing ionic currents, which are responsible for the electrical activity of the heart, as well as their propagation and effects on surrounding cells.

This thesis focuses on the study of a specific cardiac disorder, Long QT Syndrome, and its impact on normal cardiac activity. The objective is to develop a numerical model capable of interpreting the underlying electrical signals and simulating the pathological mechanisms associated with this condition.
